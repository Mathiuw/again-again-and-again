...
func _set_health_UI(current_hits: int):
	...
	match current_hits:
		0: atlas_texture.region.position = Vector2(atlas_texture.get_size().x * 5, 0)
		1: atlas_texture.region.position = Vector2(atlas_texture.get_size().x * 4, 0)
		2: atlas_texture.region.position = Vector2(atlas_texture.get_size().x * 3, 0)
		3: atlas_texture.region.position = Vector2(atlas_texture.get_size().x * 2, 0)
		4: atlas_texture.region.position = Vector2(atlas_texture.get_size().x * 1, 0)
